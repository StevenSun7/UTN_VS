...
siguiente mensaje “Hola, mi nombre es <nombre y apellido> y soy el guardia.” Donde <nombre y 
apellido> debe ser reemplazado por el nombre y apellido del guardia.
